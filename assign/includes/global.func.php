...
function _time($times){
		$hour = floor($times / (60 * 60));
	    $minute = floor($times / 60) - ($hour * 60);
	    // $second =floor($times) - ($hour * 60 * 60) - ($minute * 60);
	    $time=tow($hour).'小时 '.tow($minute).'分 ';
	    return $time;
	}
?>