...
if(@$_POST['action']=='update_admin'){
	...
	if(mysqli_affected_rows($_conn)){
		if($_POST['radio']==1){
			_alert_url_null("恭喜你，成功修改超级管理员！","super_admin.php");
		}else{
			_alert_url_null("恭喜你，成功修改管理员！","middle_admin.php");
		}
	}else{
		_alert_back_url("修改管理员信息失败！","update_admin.php");
	}
}
?>
<!DOCTYPE html>
	...
	<div class="page-container">
		...
		<div class="page-content">
			<ol class="breadcrumb">
				...
				<li><a href="middle_admin.php">普通管理员</a></li>
				<li>修改管理员</li>
			</ol>
			<p>修改管理员</p>
			<!-- content header -->
